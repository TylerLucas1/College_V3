...
('Ethan','White',1,3,NULL),
('Fiona','Green',2,4,NULL),
('George','Adams',3,NULL,3),
('Hannah','Nelson',4,NULL,4),
('Ian','Baker',1,5,NULL),
('Julia','Carter',2,6,NULL),
('Kevin','Mitchell',3,NULL,5),
('Laura','Perez',4,NULL,6),
('Mike','Roberts',1,7,NULL),
('Nina','Turner',2,8,NULL),
('Oscar','Phillips',3,NULL,7),
('Paula','Campbell',4,NULL,8),
('Quinn','Parker',1,9,NULL),
('Rachel','Evans',2,10,NULL),
('Sam','Edwards',3,NULL,9),
('Tina','Collins',4,NULL,10),
('Ulysses','Stewart',1,11,NULL),
('Vera','Morris',2,12,NULL),
('Will','Murphy',3,NULL,11),
('Xena','Cook',4,NULL,12),
('Yuri','Rogers',1,13,NULL),
('Zoe','Reed',2,14,NULL),
('Jack','Hunt',4,NULL,18),
